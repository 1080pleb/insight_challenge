...
class TestRecordParsing(unittest.TestCase):
  ...
  def test_r1(self):
    ...
    self.assertEqual(r.timestamp,
                     record.parse_time('01/Jul/1995:00:00:01 -0400'))
  ...
  def test_r2(self):
    ...
    self.assertEqual(r.timestamp,
                     record.parse_time('01/Jul/1995:00:00:06 -0400'))
    self.assertEqual(r.command, 'GET')
  ...
  def test_r3(self):
    r = record.Record(
        '193.44.126.11 - - [04/Jul/1995:13:39:01 -0400] "GET /shuttle/missions/sts-71/news HTTP/1.0" 302 -'
    )
    self.assertEqual(r.hostname, '193.44.126.11')
    self.assertEqual(r.timestamp,
                     record.parse_time('04/Jul/1995:13:39:01 -0400'))
    self.assertEqual(r.command, 'GET')
  ...
  def test_r5(self):
    ...
    self.assertEqual(r.timestamp,
                     record.parse_time('20/Jul/1995:07:34:34 -0400'))
    self.assertEqual(r.command, 'GET')
